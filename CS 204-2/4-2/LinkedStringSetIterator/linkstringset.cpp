...
/*******************************************************************/
/* Constructor */
LinkStringSet::LinkStringSet(void)
  : myFirst(new Node("header",0)), mySize(0)
{
   // header node created
}
...
/*******************************************************************/
/* Simple accessors */
int LinkStringSet::size(void) const {
    return mySize;
}
...
LinkStringSet::LinkStringSet(const LinkStringSet& set)
  : myFirst(new Node("header",set.clone())), mySize(set.size())
{
    // initializer list made deep copy
}

/*******************************************************************/
const LinkStringSet& LinkStringSet::operator = (const LinkStringSet& set) {
    if (&set != this) {
...
/*-------------------------------------------*/
LinkStringSet::Node * LinkStringSet::clone(void) const {
