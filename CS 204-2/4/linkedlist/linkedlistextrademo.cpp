...
int main(){
	...
	*																		*
	* Actually even if we do not print list2, program crashes or shows an 
	* abnormal behavior in debug mode.  This is due to trying to delete the	*
	* memory locations of the list twice (one for list1, one for list2)		*
	* by the destructor.												    *
	*																		*
...
}   // Debug with F11 at the end of program to see how destructor is invoked automatically
