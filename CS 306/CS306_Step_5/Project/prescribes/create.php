...
if ( $_SERVER['REQUEST_METHOD'] == 'POST'){
    ...
    do {
        if (empty($DocID) || empty($PatID) || empty($MedID)  ){
            $errorMessage = "All the fields are required";
            break;
        }

        //add new doctor to database
        $sql = "INSERT INTO Prescribes (DocID, PatID, MedID)" .
            "VALUES ('$DocID', '$PatID', '$MedID')";
        ...
        $successMessage = "Medicine Prescribed Successfully!";
...
<body>
    <div class="container my-5">
        <h2>Precribe Medicine to Patient</h2>
