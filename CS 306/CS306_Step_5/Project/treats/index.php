...
<body>
    <div class="container my-5">
        <h2>List of patients treated by doctors</h2>
        <a class="btn btn-primary" href="/Project/treats/create.php" role="button">Assign a new doctor</a>
        <a class="btn btn-primary" href="/Project/treats/select.php" role="button">Search</a>
        <br>
        <table class="table">
            <thead>
                <tr>
            ...
            <tbody>
                ...
                while($row = $result -> fetch_assoc()){
                    ...
                    <tr>
                        ...
                        <td>$row[PatID]</td>
                        <td>
                            <a class='btn btn-danger btn-sm' href='/Project/treats/delete.php?DocID=$row[DocID]'>Delete</a>
                        </td>
                    </tr>
                    ";
                }
