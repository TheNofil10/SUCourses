...
<body>
    <div class="container my-5">
        ...
        <a class="btn btn-primary" href="/Project/doctors/create.php" role="button">New Doctor</a>
        <a class="btn btn-primary" href="/Project/doctors/select.php" role="button">Search</a>
        <a class="btn btn-primary" href="/Project/prescribes/index.php" role="button">Prescribe Medicine to patient</a>
            ...
            <tbody>
                ...
                while($row = $result -> fetch_assoc()){
                    ...
                    <tr>
                        ...
                        <td>
                            <a class='btn btn-danger btn-sm' href='/Project/doctors/delete.php?DocID=$row[DocID]'>Delete</a>
                        </td>
                    </tr>
                    ";
                }
