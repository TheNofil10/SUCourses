...
<body>
    <div class="container my-5">
        ...
        <a class="btn btn-primary" href="/Project/nurses/create.php" role="button">New Nurse</a>
        <a class="btn btn-primary" href="/Project/nurses/select.php" role="button">Search</a>
        <br>
        <table class="table">
            <thead>
                <tr>
            ...
            <tbody>
                ...
                while($row = $result -> fetch_assoc()){
                    ...
                    <tr>
                        ...
                        <td>$row[Age]</td>
                        <td>
                            <a class='btn btn-danger btn-sm' href='/Project/nurses/delete.php?NurseID=$row[NurseID]'>Delete</a>
                        </td>
                    </tr>
                    ";
                }
