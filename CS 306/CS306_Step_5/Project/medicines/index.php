...
<body>
    <div class="container my-5">
        ...
        <a class="btn btn-primary" href="/Project/medicines/create.php" role="button">New Medicine</a>
        <a class="btn btn-primary" href="/Project/medicines/select.php" role="button">Search</a>
        <br>
        <table class="table">
            <thead>
                <tr>
            ...
            <tbody>
                ...
                while($row = $result -> fetch_assoc()){
                    ...
                    <tr>
                        ...
                        <td>$row[Inventory]</td>
                        <td>
                            <a class='btn btn-danger btn-sm' href='/Project/medicines/delete.php?MedID=$row[MedID]'>Delete</a>
                        </td>
                    </tr>
                    ";
                }
