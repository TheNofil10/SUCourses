<?php 
    ...
    $URL = "https://cs306-6297b-default-rtdb.europe-west1.firebasedatabase.app/messages.json";
	...
	header('location: http://localhost/project/AdminPanel/Adminchat/' . $params['sender'] .'_chat.php');
?>