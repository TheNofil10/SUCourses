...
<body>
    <div class="container my-5">
        <h2>List Room assigned to Patients</h2>
        <a class="btn btn-primary" href="/Project/assigns/create.php" role="button">Assign room to Patient</a>
        <a class="btn btn-primary" href="/Project/assigns/select.php" role="button">Search</a>
        <br>
        <table class="table">
            <thead>
                <tr>
            ...
            <tbody>
                ...
                while($row = $result -> fetch_assoc()){
                    ...
                    <tr>
                        ...
                        <td>$row[RoomID]</td>
                        <td>
                            <a class='btn btn-danger btn-sm' href='/Project/assigns/delete.php?RoomID=$row[RoomID]'>Delete</a>
                        </td>
                    </tr>
                    ";
                }
