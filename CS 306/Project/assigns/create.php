...
if ( $_SERVER['REQUEST_METHOD'] == 'POST'){
    ...
    do {
        if (empty($DocID) || empty($PatID) || empty($RoomID)  ){
            $errorMessage = "All the fields are required";
            break;
        }

        //add new doctor to database
        $sql = "INSERT INTO assigns (DocID, PatID, RoomID)" .
            "VALUES ('$DocID', '$PatID', '$RoomID')";
        ...
        $successMessage = "Room assigned Successfully!";
        ...
        <form method="post">
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-3 d-grid">
                    <a class="btn btn-outline-primary" href="/Project/assigns/index.php" role="button">Cancel</a>
                </div>
            </div>
        </form>
    </div>
