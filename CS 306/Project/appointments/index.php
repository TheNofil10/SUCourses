...
<body>
    <div class="container my-5">
        ...
        <a class="btn btn-primary" href="/Project/appointments/select.php" role="button">Search</a>
        <br>
        <table class="table">
            <thead>
                <tr>
            ...
            <tbody>
                ...
                while($row = $result -> fetch_assoc()){
                    ...
                    <tr>
                        ...
                        <td>$row[Date]</td>
                        <td>
                            <a class='btn btn-danger btn-sm' href='/Project/appointments/delete.php?AppID=$row[AppID]'>Delete</a>
                        </td>
                    </tr>
                    ";
                }
